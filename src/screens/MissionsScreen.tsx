...
export function MissionsScreen() {
  ...
  return (
    <div>
      <PageHeader title="Missions" description={`${source.length} mission(s) au total.`} />
      ...
      {filtered.length === 0 ? (
        ...
        <div className="overflow-hidden rounded-lg border border-border bg-surface-1">
          ...
          <div
            className={cn(
              "hidden items-center gap-3 border-b border-border px-4 py-2 text-label uppercase tracking-wide text-text-muted tablet:grid",
              columns,
            )}
          >
            <span>Objectif</span>
