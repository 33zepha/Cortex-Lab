...
/** Effet "verre liquide" au survol — dock (Nexus, MobileNav). */
export const LIQUID_GLASS_HOVER =
  "hover:bg-white/40 hover:backdrop-blur-md hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.9),0_4px_12px_rgba(0,0,0,0.06)]";
